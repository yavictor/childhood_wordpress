...
<html lang="ru">
	<head>
        ...
        <link rel="shortcut icon" href="<?php echo bloginfo( 'template_url' ); ?>/favicons/favicon.ico" type="image/x-icon">
        <link rel="apple-touch-icon" href="<?php echo bloginfo( 'template_url' ); ?>/favicons/apple-touch-icon.png">
